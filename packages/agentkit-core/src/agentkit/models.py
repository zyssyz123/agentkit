...
their own entry-point group ``agentkit.models``.
...
ENTRY_POINT_GROUP_MODELS = "agentkit.models"
...
class ModelHub:
    ...
    Pass the hub to Techniques via :class:`agentkit.protocols.BootContext`.
    """
    ...
    def discover_factories() -> dict[str, Callable[..., ModelProvider]]:
        """Load all registered ``agentkit.models`` factories keyed by their entry-point name.
