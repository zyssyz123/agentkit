...
A plugin process typically boils down to::
    ...
    from agentkit.plugin_sdk import PluginServer, register
...
:mod:`agentkit.loader.subprocess` so it interoperates with AgentKit's
...
class PluginServer:
    """JSON-RPC server speaking AgentKit's subprocess wire protocol over stdio."""
