...
Embeddings are produced via the AgentKit :class:`ModelHub` so any provider
...
Config schema::
    ...
    config:
      ...
      seed:                        # optional documents to ingest at startup
        - "AgentKit is a pluggable Agent runtime."
...
from agentkit.context import AgentContext, ContextPatch, MemoryItem
